...
export function LevelProgress({ userLevel }: LevelProgressProps) {
  ...
  return (
    <div className="w-full max-w-md mx-auto p-4 bg-card rounded-lg shadow-md border">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center">
          <Trophy className="w-6 h-6 text-yellow-500 dark:text-yellow-400 mr-2" />
          <h2 className="text-xl font-bold text-card-foreground">Level {userLevel.currentLevel}</h2>
        </div>
